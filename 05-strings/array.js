...
let fruit = ['Apple','Banana','Cherries','Durian','Oranges']

// first index is WHERE to start deleting from
// second index is HOW many I want to delete
fruits.splice(2, 1);
console.log('fruits.splice(2, 1) =>', fruits);

let numbers = [1,3,5,7,9,11,13];
numbers.splice(2, 3) // start deleting at index and delete 3 items from index 2
